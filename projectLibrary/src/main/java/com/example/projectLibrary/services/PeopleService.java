package com.example.projectLibrary.services;

import com.example.projectLibrary.model.Book;
import com.example.projectLibrary.model.Person;
import com.example.projectLibrary.repositories.PeopleRepository;
    ...
    public List<Book> getBooksByPersonId(int id) {
        ...
        if (person.isPresent()) {
            ...
            person.get().getBooks().forEach(book -> {
                long diffInMillies = Math.abs/*берет модуль*/(book.getTakenAt().getTime() - new Date().getTime());
